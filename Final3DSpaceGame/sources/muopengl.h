...
struct tMd3Tag
{
	...
	LVector3	vPosition;				// This stores the translation that should be performed
...
class CModelMD3 : public MUmovnode
{
...
//RWW here
	bool CreateTexture(UINT &texture, char *strFileName, int textureID);
...
public:
	...
	CQuaternion(float xx, float yy, float zz, float ww) 
	{ 
		x = xx;		y = yy;		z = zz;		w = ww;
	}
